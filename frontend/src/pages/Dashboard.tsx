...
const Dashboard = () => {
  ...
  const userId = localStorage.getItem("InstaShield_user_id");
  const userName = localStorage.getItem("InstaShield_name") || "Worker";
  const userLocation = localStorage.getItem("InstaShield_location") || "HSR Layout";
