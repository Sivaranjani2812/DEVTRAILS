...
const Profile = () => {
  ...
  const name = localStorage.getItem("InstaShield_name") || "Arjun K";
  const location = localStorage.getItem("InstaShield_location") || "HSR Layout";
  const plan = localStorage.getItem("InstaShield_selected_plan") || "Standard Plan";
